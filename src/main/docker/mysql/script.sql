...
INSERT INTO `space` (`id`, `name`, `type`, `people_capacity`, `area`, `price`, `description`, `image_url`,
                     `image_credit`,
                     `building_id`)
VALUES (1, 'Salon', 'PRIVATE', 4, 20, 1000.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
        '/coworking-spaces/1.jpg',
        'Créateur: Andreas Lukoschek, droits d\'auteur: Coworkoffice', 5),
(2, 'Aile de Paillettes', 'PRIVATE', 6, 14, 1250.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/2.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Asnieres Sur Seine', 10),
(3, 'War Room', 'PRIVATE', 10, 20, 2000.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/3.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: La Maison de l''Afrique', 2),
(4, 'Le QG', 'PRIVATE', 6, 18, 1300.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/4.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Bird Office', 12),
(5, 'L104', 'PRIVATE', 20, 40, 2800.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/5.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: atoffice.lu', 1),
(6, 'L108', 'PRIVATE', 20, 45, 2900.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/6.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: atoffice.lu', 1),
(7, 'Les guichets', 'PRIVATE', 4, 8, 750.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/7.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Moucron Coworking', 8),
(8, 'L\'aquarium A', 'PRIVATE', 8, 22, 2000.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/8.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: atoffice.lu', 6),
(9, 'L\'aquarium B', 'PRIVATE', 8, 22, 2000.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/9.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Le 114', 6),
(10, 'All Start Nest', 'OPEN', 12, 25, 50.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/10.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Officedropin.com', 6),
(11, 'Salle 1', 'OPEN', 60, 100, 30.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/11.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: trilux.com', 8),
(12, 'Salle 2', 'OPEN', 80, 120, 30.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/12.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: SmartWork Brussels', 8),
(13, 'B-Rocket Launch Pad', 'OPEN', 20, 60, 50.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/13.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Skylab Factory', 6),
(14, 'Salle des tatamis', 'OPEN', 40, 60, 30.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/14.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Skylab Factory', 1),
(15, 'La Tonte', 'OPEN', 10, 28, 50.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/15.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Skylab Factory', 9),
(16, 'L\'enjambée', 'OPEN', 16, 34, 20.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/16.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Skylab Factory', 7),
(17, 'L\'ossature', 'OPEN', 8, 20, 60.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/17.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Skylab Factory', 4),
(18, 'Le massage', 'OPEN', 8, 20, 60.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/18.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: cityplug.be', 4),
(19, 'Le hamam', 'OPEN', 4, 10, 100.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/19.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Axis Parc', 4),
(20, 'Le sauna', 'OPEN', 10, 20, 80.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/20.png',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Officedropin.com', 4),
(21, 'Véranda', 'BUBBLE', 2, 16, 200.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/21.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Sweetspot', 5),
(22, 'Chambre d\'Adrien', 'BUBBLE', 2, 20, 250.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/22.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Smartwork Monnaie', 5),
(23, 'Nid Douillet', 'BUBBLE', 3, 12, 300.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/23.png',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Smartwork Amsterdam', 15),
(24, 'Lieu d\'aisance', 'BUBBLE', 1, 2, 100.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/24.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Steelcase.com', 7),
(25, 'Concentration', 'BUBBLE', 1, 3, 100.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
 '/coworking-spaces/25.jpg',
 'Créateur: Andreas Lukoschek, droits d\'auteur: Belgian Workspace Association', 6),
(26, 'Le bureau de Nicobo', 'BUBBLE', 1, 20, 1000.0, 'PLACEHOLDER DESCRIPITION, REPLACE THAT!',
