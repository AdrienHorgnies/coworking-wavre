...
INSERT INTO `spaces` (`id`, `name`, `area`, `location`) VALUES
(NULL, 'espace1', 20, 'Grand place 29 - 1360 Perwez'),
(NULL, 'espace2', 25, 'Place Bosch 29 - 1300 Wavre'),
(NULL, 'espace3', 30, 'Place de la Gare 1 - 1300 Wavre');
